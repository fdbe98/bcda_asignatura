...
contract('Uso normal de Asignatura:', accounts => { const profesor = accounts[0];
 const desconocido = accounts[9];
 // Alumnos que se van a automatricular
 const alumnos = [ {addr: accounts[4], nombre: "Pepe", email: "pepe@upm.es"},
 ...
 const evaluaciones = [ {nombre: "Parcial 1", fecha: Date
.now() + 60 * 24 * 3600000, porcentaje: 30}, {nombre: "Parcial 2", fecha: Date
.now() + 120 * 24 * 3600000, porcentaje: 30}, {nombre: "Practica 1", fecha: Date
.now() + 50 * 24 * 3600000, porcentaje: 20}, {nombre: "Practica 1", fecha: Date
.now() + 110 * 24 * 3600000, porcentaje: 20
}
 ];
 ...
 const calificaciones = [ [[1,0], [2, 400], [2, 750], [2, 900]], // Notas del primer alumno 
